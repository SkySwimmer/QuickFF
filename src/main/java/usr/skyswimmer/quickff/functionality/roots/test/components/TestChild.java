package usr.skyswimmer.quickff.functionality.roots.test.components;
...
import usr.skyswimmer.quickff.functionality.roots.test.TestRootComponent;

@AttachToContextComponent(TestRootComponent.class)
public class TestChild implements BaseContextComponent<TestContext> {
